...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('student')->name('student.')->middleware('role:student')->group(function () {
        ...
        Route::post('/enter-token', [StudentDashboardController::class, 'enterToken'])->name('enter-token')->middleware('throttle:10,1');
...
// Diagnostics must never expose infrastructure details outside local development.
